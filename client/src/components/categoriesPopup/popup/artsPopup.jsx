...
export default function Arts({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Arts & Crafts?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Arts & Crafts?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Arts & Crafts?</label>
              </div>
