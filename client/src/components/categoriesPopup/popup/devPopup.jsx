...
export default function DevOpss({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in DevOps?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in DevOps?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in DevOps?</label>
              </div>
