...
export default function Datanalytic({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Data analytics?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Data analytics?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Data analytics?</label>
              </div>
