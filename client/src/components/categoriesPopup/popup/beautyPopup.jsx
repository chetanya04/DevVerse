...
export default function Beauty({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Beauty & Cosmetic?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Beauty & Cosmetic?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Beauty & Cosmetic?</label>
              </div>
