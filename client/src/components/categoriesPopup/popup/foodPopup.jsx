...
export default function Food({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Food Delivery?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Food Delivery?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Food Delivery?</label>
              </div>
