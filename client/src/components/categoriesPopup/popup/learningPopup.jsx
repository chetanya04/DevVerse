...
export default function Learning({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in E-Learning Platforms?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in E-Learning Platforms?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in E-Learning Platforms?</label>
              </div>
