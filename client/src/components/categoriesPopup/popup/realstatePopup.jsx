...
export default function Realestate({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Real Estate?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Real Estate?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Real Estate?</label>
              </div>
