...
export default function Travell({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Travel & Tourism?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Travel & Tourism?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Travel & Tourism?</label>
              </div>
