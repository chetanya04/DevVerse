      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Web Development?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Web Development?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Web Development?</label>
              </div>
