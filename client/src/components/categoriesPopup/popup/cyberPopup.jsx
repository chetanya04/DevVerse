...
export default function Cyber({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Cyber Security?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Cyber Security?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Cyber Security?</label>
              </div>
