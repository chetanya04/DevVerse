...
export default function Human({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Human Resource?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Human Resource?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Human Resource?</label>
              </div>
