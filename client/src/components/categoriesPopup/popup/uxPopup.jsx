...
export default function CategoriesUx({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in UX/UI Design?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in UX/UI Design?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in UX/UI Design?</label>
              </div>
