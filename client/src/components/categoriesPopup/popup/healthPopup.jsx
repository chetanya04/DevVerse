      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Health Care?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Health Care?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Health Care?</label>
              </div>
