...
export default function Customer({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Customer Service?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Customer Service?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Customer Service?</label>
              </div>
