...
export default function Sports({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Sports & Recreation?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Sports & Recreation?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Sports & Recreation?</label>
              </div>
