...
export default function Virtual({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Virtual Private Network?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Virtual Private Network?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Virtual Private Network?</label>
              </div>
