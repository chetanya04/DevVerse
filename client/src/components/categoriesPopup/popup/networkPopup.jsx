...
export default function Network({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Networking?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Networking?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Networking?</label>
              </div>
