...
export default function Outdoors({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Outdoors & Adventure?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Outdoors & Adventure?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Outdoors & Adventure?</label>
              </div>
