...
export default function Cloud({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Cloud Computing?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Cloud Computing?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Cloud Computing?</label>
              </div>
