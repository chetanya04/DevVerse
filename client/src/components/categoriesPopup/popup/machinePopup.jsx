...
export default function CategoriesMachine({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Machine Learning?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Machine Learning?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Machine Learning?</label>
              </div>
