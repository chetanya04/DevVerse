...
export default function CategoriesMarketing({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Agriculture?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Agriculture?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Agriculture?</label>
              </div>
