...
export default function Photography({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Photography?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Photography?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Photography?</label>
              </div>
