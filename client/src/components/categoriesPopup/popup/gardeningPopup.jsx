...
export default function Agri({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Gardening & Landscaping?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Gardening & Landscaping?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Gardening & Landscaping?</label>
              </div>
