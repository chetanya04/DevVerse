...
export default function Parenting({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Parenting & Family?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Parenting & Family?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Parenting & Family?</label>
              </div>
