...
export default function Blockchain({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Blockchain?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Blockchain?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Blockchain?</label>
              </div>
