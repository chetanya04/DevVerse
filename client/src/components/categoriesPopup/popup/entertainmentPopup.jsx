...
export default function Entertainments({ onClose }) {
      ...
      {!showCategoriesPopup && (
        <div className="problem-modal" onClick={handleClickOutside}>
          <div className="modal-containers">
            ...
            <h2>What kind of problem are you facing in Entertainment?</h2>
            <form>
              <div className="input-fields">
                ...
                />
                <label>How to develop strategies in Entertainment?</label>
              </div>
              ...
              <div className="input-fields">
                ...
                />
                <label>How to solve technical issues in Entertainment?</label>
              </div>
